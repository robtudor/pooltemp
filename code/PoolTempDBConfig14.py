...
def get_config():
    ...
    if conn != "Error": # Database Unavailable
        ...
        try:  
            ...
            for dmaxpooltemp, dstarthour, dendhour, droofpooldelta, dsleeptime, dstartmonth, dendmonth, dlcdtimer in cursor: 
                return dmaxpooltemp, dstarthour, dendhour, droofpooldelta, dsleeptime, dstartmonth, dendmonth, dlcdtimer
...
def display_lcd(lcdline2, lcdline3, lcdline4):
    ...
    if not GPIO.input(20):
        #print (datetime.datetime.now().strftime('%d-%m-%Y %H.%M.%S'), 1)
        lcd = LCD()
...
try:
    while True:
        ...
        try:
            ...
            poolsensorfault = 1
        print (roofsensorfault, poolsensorfault)
        connect_database()
        date = date.today()
        month = date.month
        ...
        maxpooltemp, starthour, endhour, roofpooldelta, sleeptime, startmonth, endmonth, lcdtime = dmaxpooltemp
